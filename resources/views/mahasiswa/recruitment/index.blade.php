    ...
    <div class="flex-1">
        @if($ormawas->isNotEmpty())
            <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                ...
                <a href="{{ route('mahasiswa.recruitment.show', $ormawa->slug) }}" class="group relative flex flex-col h-full bg-white rounded-3xl p-4 sm:p-6 transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_20px_40px_-15px_rgba(59,130,246,0.15)] ring-1 ring-slate-200/80 hover:ring-blue-500/30 overflow-hidden">
                    ...
                    <div class="relative z-10 flex flex-col h-full">
                        <div class="flex items-start gap-3 sm:gap-4 mb-4 sm:mb-5">
                            @if($ormawa->logo)
                                <div class="relative w-12 h-12 sm:w-14 sm:h-14 shrink-0 rounded-2xl overflow-hidden bg-white shadow-sm ring-1 ring-slate-100 group-hover:shadow-md transition-shadow duration-300">
                            ...
                            @else
                                <div class="relative w-12 h-12 sm:w-14 sm:h-14 bg-gradient-to-br from-slate-50 to-slate-100 group-hover:from-blue-50 group-hover:to-indigo-50 rounded-2xl flex items-center justify-center text-slate-700 group-hover:text-blue-700 text-base sm:text-lg font-black shrink-0 shadow-sm ring-1 ring-slate-200 group-hover:ring-blue-200 group-hover:shadow-md transition-all duration-300">
