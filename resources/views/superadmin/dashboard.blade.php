...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
    <div class="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm hover:shadow-md transition-shadow">
        ...
        <p class="text-3xl font-bold text-slate-800">{{ $stats["total_ormawa"] }}</p>
    ...
    <div class="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm hover:shadow-md transition-shadow">
        ...
        <p class="text-3xl font-bold text-slate-800">{{ $stats["total_admin"] }}</p>
    ...
    <div class="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm hover:shadow-md transition-shadow">
        ...
        <p class="text-3xl font-bold text-slate-800">{{ $stats["total_mahasiswa"] }}</p>
    ...
    <div class="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm hover:shadow-md transition-shadow">
        ...
        <p class="text-3xl font-bold text-slate-800">{{ $stats["rekrutmen_aktif"] }}</p>
        <p class="text-sm text-slate-500 mt-1">Rekrutmen Aktif</p>
    </div>
</div>
<div class="bg-white rounded-2xl border border-slate-200 shadow-sm">
    <div class="px-6 py-4 border-b border-slate-200"><h3 class="text-lg font-semibold text-slate-800">Rekrutmen Terbaru</h3></div>
