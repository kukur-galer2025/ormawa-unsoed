...
<button type="submit" class="w-full py-3 bg-gradient-to-r from-purple-600 to-indigo-600 text-white font-semibold rounded-xl shadow-lg shadow-purple-500/25 hover:from-purple-500 hover:to-indigo-500" onclick="return confirm('Jalankan kalkulasi Profile Matching?')">🔄 Jalankan Kalkulasi Profile Matching</button>
</form>
