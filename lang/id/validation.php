...
return [
    ...
    'digits'               => 'Kolom :attribute harus berupa angka dengan panjang :digits digit.',
    ...
    'extensions'           => 'Kolom :attribute harus memiliki ekstensi salah satu dari berikut: :values.',
    ...
    'password'             => [
        ...
        'uncompromised' => 'Kolom :attribute yang diberikan telah muncul dalam kebocoran data. Silakan gunakan :attribute yang berbeda.',
    ],
    ...
    'prohibits'            => 'Kolom :attribute tidak memperbolehkan :other untuk hadir.',
    ...
    */
    'custom' => [
        'nim' => [
            ...
            'size'     => 'NIM harus tepat 9 karakter.',
            'regex'    => 'Format NIM tidak valid. Gunakan huruf kapital dan angka.',
            'unique'   => 'NIM tersebut sudah terdaftar, gunakan NIM yang lain.',
        ],
        'no_hp' => [
            'regex' => 'Nomor HP harus berupa 10-13 digit angka.',
        ],
        'email' => [
        ...
        'fakultas_id' => [
            ...
            'exists'   => 'Fakultas yang dipilih tidak valid.',
        ],
        'jurusan_id' => [
            'required' => 'Jurusan wajib dipilih.',
            'exists'   => 'Jurusan yang dipilih tidak valid.',
        ],
        'angkatan' => [
            'required' => 'Angkatan wajib diisi.',
            'integer'  => 'Angkatan harus berupa tahun (angka).',
            'digits'   => 'Angkatan harus berupa 4 digit tahun.',
            'min'      => 'Angkatan tidak valid.',
            'max'      => 'Angkatan tidak boleh melebihi tahun saat ini.',
        ],
        'foto' => [
            'image' => 'File foto harus berupa gambar (JPG/PNG/JPEG).',
    ...
    */
    'attributes' => [
        ...
        'berkas_pendukung' => 'berkas persyaratan',
        'motivasi'    => 'motivasi bergabung',
    ],
